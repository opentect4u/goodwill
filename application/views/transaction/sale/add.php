...
<script> 
  ...
  $(document).ready(function() {                                        //discount rate change
          ...
          $('.table tbody').on('change', '.Dis_Rate', function(){
            ...
            tot_net_price=parseFloat(tot_net_price).toFixed(2);
           ...
           // total_net += parseFloat(netPrice); 
            ...
            document.getElementById('totamt').value=total_net.toFixed('0') ; 
    ...
    <script> 
        $(document).ready(function() {                //Quantity change 
        ...
        $('.table tbody').on('change', '.qty', function(){      //On quantity change the totals
