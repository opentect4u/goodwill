    ...
    <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <br><br>
                    <form class="form-sample" method="POST" id="prod_form" action="<?php echo site_url('Masters/addProduct'); ?>">
                      <div class="row">
                        <div class="col-md-6">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="gst_rt" required/>
                            </div>
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group row">
                            ...
                            <select class="js-example-basic-single w-100" id="hsngrp" name="hsn">
                              ...
                              <?php foreach($hsn as $row) { ?>
                                <option value="<?php echo $row->Code;?>"><?php echo $row->Grp;?></option>
                                <?php
                                  }
                                ?>
                            </select>
