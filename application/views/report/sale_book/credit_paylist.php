              ...
              <div class="row">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Credit Payment  : <?php echo date('d/m/Y',strtotime($_POST['from_dt'])).' To '.date('d/m/Y',strtotime($_POST['to_dt']));?></h4>
                    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                     ...
                                     <td><?php echo $dtls->net_price; ?></td>
                                     <td><?php echo $dtls->amt; ?></td>
                                     <td><?php echo $dtls->paid_dt; ?></td>
                                </tr>
                                <?php        
                                    }
                                ?>
